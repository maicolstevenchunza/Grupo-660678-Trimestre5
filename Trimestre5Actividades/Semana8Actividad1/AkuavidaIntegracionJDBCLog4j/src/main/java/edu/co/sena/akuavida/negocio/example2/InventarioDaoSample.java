...
public class InventarioDaoSample {
    ...
    public static void main(String[] arg) throws Exception {
        ...
        in.setIdInventario(1);
        in.setCantidad(12);
        in.setProductoIdProducto("1");
        in.setCantidadProductoComprado(8);
        in.setFechaDeCompra(fechaActual);

        InventarioDao inva = getInventarioDao();
        inva.insert(in);
        findAll();
