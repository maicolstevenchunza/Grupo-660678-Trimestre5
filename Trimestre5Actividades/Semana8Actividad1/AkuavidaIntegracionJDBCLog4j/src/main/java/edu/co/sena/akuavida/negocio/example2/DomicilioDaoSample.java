...
public class DomicilioDaoSample
{
	...
	public static void main(String[] arg) throws Exception
	{
		...
		// findWhereTelefonoEquals("");
            ...
            dom.setMunicipioIdmunicipio("1");
            dom.setCuentaTipoDocumento("T.I");
            dom.setCuentaNumeroDocumento("97101306287");
            dom.setCiudad("Medellin");
            dom.setDireccion("Crr 1 a #78-17 sur");
            dom.setTelefono("7688011");
            
            DomicilioDao domi= getDomicilioDao();
            domi.insert(dom);
            findAll();
            
            System.out.println("---------------------------");
            
            dom.setCiudad("Bogota");
            dom.setDireccion("Crr 3c #54-95 sur");
            domi.update(dom.createPk(), dom);
	}
