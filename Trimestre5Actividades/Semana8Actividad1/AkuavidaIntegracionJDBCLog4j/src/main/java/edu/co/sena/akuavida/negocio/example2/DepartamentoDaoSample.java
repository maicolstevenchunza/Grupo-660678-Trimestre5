...
public class DepartamentoDaoSample {
    ...
    public static void main(String[] arg) throws Exception {
        ...
        Departamento det = new Departamento();
        det.setIdDepartamento("1");
        det.setNombreDepartamento("Amazonas");

        DepartamentoDao dee = getDepartamentoDao();
        dee.insert(det);
        findAll();
        System.out.println("-----------------------------------");

        det.setNombreDepartamento("Antioquia");
        dee.update(det.createPk(), det);
    }
