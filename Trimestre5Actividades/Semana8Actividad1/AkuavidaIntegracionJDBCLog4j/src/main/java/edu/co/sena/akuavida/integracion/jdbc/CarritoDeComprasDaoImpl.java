...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	 ...
	 */
	protected final String SQL_SELECT = "SELECT ID_Carrito, precio, Total, Subtotal FROM " + getTableName() + "";
	 ...
	 */
	protected final String SQL_INSERT = "INSERT INTO " + getTableName() + " ( ID_Carrito, precio, Total, Subtotal ) VALUES ( ?, ?, ?, ? )";

	/** 
	 * SQL UPDATE statement for this table
	 */
	protected final String SQL_UPDATE = "UPDATE " + getTableName() + " SET ID_Carrito = ?, precio = ?, Total = ?, Subtotal = ? WHERE ID_Carrito = ?";
	 ...
	 */
	protected static final int COLUMN_PRECIO = 2;
	 ...
	 */
	protected static final int COLUMN_SUBTOTAL = 4;
	...
	/** 
	 * Returns all rows from the carrito_de_compras table that match the criteria 'precio = :precio'.
	 */
	public CarritoDeCompras[] findWherePrecioEquals(float precio) throws CarritoDeComprasDaoException
	{
