...
public class ItemsDelCarritoDaoSample
{
	...
	public static void main(String[] arg) throws Exception
	{
		...
		// findWhereCarritoDeComprasIdCarritoEquals("");
            ...
            ItemsDelCarrito item=new ItemsDelCarrito();
            item.setProductoIdProducto("1");
            item.setCantidad(2);
            item.setCostoUnitario(360000);
            item.setCostoTotal(0);
            item.setCarritoDeComprasIdCarrito("1");
            
            ItemsDelCarritoDao item1= getItemsDelCarritoDao();
            item1.insert(item);
            findAll();
            System.out.println("-------------------------------------");
            
            item.setCantidad(3);
            item.setCostoUnitario(420000);
            item1.update(item.createPk(), item);
            findAll();
	}
