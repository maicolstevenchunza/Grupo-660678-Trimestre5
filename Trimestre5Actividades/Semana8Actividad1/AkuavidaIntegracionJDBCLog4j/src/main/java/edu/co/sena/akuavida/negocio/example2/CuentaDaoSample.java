...
public class CuentaDaoSample
{
	...
	public static void main(String[] arg) throws Exception
	{
		...
		// findWhereUsusarioIdususarioEquals("");
            ...
            cu.setTipoDocumento("T.I");
            cu.setNumeroDocumento("97101306287");
            cu.setPrimerNombre("Michael");
            cu.setSegundoNombre("Steven");
            cu.setPrimerApellido("Chunza");
            cu.setSegundoApellido("Alfonso");
            cu.setContrasena("123456");
            cu.setCorreo("maicol45op@gmail.com");
            cu.setDireccion("Crr 1a#78-17 sur");
            cu.setTelefono("6611026");
            cu.setRool("Cliente");
            cu.setActivo(new Short("1"));
            cu.setUsusarioIdususario("1");
            
            CuentaDao cuen= getCuentaDao();
            cuen.insert(cu);
            findAll();
            
            System.out.println("-------------------------------");
            
            cu.setDireccion("crr 2b # 45-25 sur");
            cu.setTelefono("7688011");
            cuen.update(cu.createPk(), cu);
