...
public class CarritoDeComprasDaoSample {
    ...
    public static void main(String[] arg) throws Exception {
        ...
        CarritoDeCompras ct1 = new CarritoDeCompras();
        ct1.setIdCarrito("1");
        ct1.setPrecio(0);
        ct1.setTotal(0);
        ct1.setSubtotal(0);

        CarritoDeComprasDao daC1 = getCarritoDeComprasDao();
        daC1.insert(ct1);
        findAll();
        System.out.println("------------------------------------------");
        ct1.setPrecio(1600000);
        daC1.update(ct1.createPk(), ct1);
        findAll();
        System.out.println("------------------------------------------");

        ct1.setIdCarrito("1");
        daC1.delete(ct1.createPk());
        findAll();
    }
    ...
    public static void findWherePrecioEquals(float precio) {
        try {
            CarritoDeComprasDao _dao = getCarritoDeComprasDao();
            CarritoDeCompras _result[] = _dao.findWherePrecioEquals(precio);
            for (int i = 0; i < _result.length; i++) {
                display(_result[i]);
            }
