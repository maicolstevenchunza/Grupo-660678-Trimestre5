...
public class ItemDaoSample
{
	...
	public static void main(String[] arg) throws Exception
	{
		...
		// findWhereCostoUnitarioEquals(0);
            ...
            Item it= new Item();
            it.setProductoIdProducto("1");
            it.setPedidoFacturaIdFactura(1);
            it.setCantidad(10);
            it.setCostoTotal(0);
            it.setCostoUnitario(360000);
            
            ItemDao ite= getItemDao();
            ite.insert(it);
            findAll();
            System.out.println("--------------------------------");
            
            it.setCantidad(13);
            it.setCostoUnitario(420000);
            ite.update(it.createPk(), it);
            findAll();
