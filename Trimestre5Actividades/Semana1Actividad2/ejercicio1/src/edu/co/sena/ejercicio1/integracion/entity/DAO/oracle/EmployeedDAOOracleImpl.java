...
public class EmployeedDAOOracleImpl implements EmployeedDAO{
    ...
    public void insert(PeopleDTO e) {
        System.out.println("inserte el empleado en oracle " + e.toString());
    }

    @Override
    public void update(PeopleDTO e) {
        System.out.println("actualize empleado en oracle " + e.toString());
    }

    @Override
    public void delete(PeopleDTO e) {
        System.out.println("borre empleado en oracle " + e.toString());
    }
