...
public class TestItemCounter {
    ...
    public static void main(String[] args) {
        ...
        for (DukeTransaction transaction : transactions) {
            ...
            switch (transaction.getTransactionType()) {
                ...
                case "Purchase":
                    ...
                    break;
                default:
                    System.out.println("Error: Invalis Transaction Type");
                    continue;
        ...
        Comparator sortDescripcion= new SortShirtByDesc();
        Comparator sortCount= new SortShirtByCount();
        
        Collections.sort(poloList, sortDescripcion);
        System.out.println("=== Inventory Report - Descripcion ===");
